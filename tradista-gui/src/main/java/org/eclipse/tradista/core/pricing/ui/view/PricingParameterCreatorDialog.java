package org.eclipse.tradista.core.pricing.ui.view;
...
public class PricingParameterCreatorDialog extends TradistaDialog<PricingParameter> {
	...
	public PricingParameterCreatorDialog() {
		super();
		String entityName = "Pricing Parameter";
		...
		grid.add(quoteSetLabel, 1, 3);
		grid.add(quoteSetComboBox, 2, 3);
		...
		setResultConverter(b -> {
			if (b == buttonTypeOk) {
				...
				return new PricingParameter(nameTextField.getText(), quoteSetComboBox.getValue(), po);
			}
			return null;
		});

...
@Entity
public class GenerateOutgoingMessage extends Process<OutgoingMessage> {
	...
	public GenerateOutgoingMessage() {
		...
		setTask(msg -> msg
				.setOutgoingMessage(exporterBusinessDelegate.generateOutgoingMessage(msg.getOriginalMessage())));
	}

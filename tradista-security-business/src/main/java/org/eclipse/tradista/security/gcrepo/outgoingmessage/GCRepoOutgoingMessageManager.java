package org.eclipse.tradista.security.gcrepo.outgoingmessage;
...
public interface GCRepoOutgoingMessageManager<X> extends RepoOutgoingMessageManager<X, GCRepoTrade> {

	static GCRepoTradeBusinessDelegate gcRepoTradeBusinessDelegate = new GCRepoTradeBusinessDelegate();

	@Override
	public default X createContent(X externalMessage, GCRepoTrade trade) {
		externalMessage = RepoOutgoingMessageManager.super.createContent(externalMessage, trade);
		externalMessage = createBasket(externalMessage, trade);
		return externalMessage;
	}

	X createBasket(X externalMessage, GCRepoTrade trade);
